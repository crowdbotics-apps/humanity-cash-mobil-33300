...
export const dataTableModelBlockChain = {
  columns: [
...
export const dataTableModelACH = {
  columns: [
...
export const renderTableRowACH = (item, onAction) => {
...
export const renderTableRowBlockchain = (item ) => {
  item.transaction_id = (hashBox(item.transaction_id))
