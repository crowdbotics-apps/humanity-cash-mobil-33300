...
export const Header = observer(function Header(props: HeaderProps) {
  ...
  const { headerText, headerTx, style, titleStyle, bigHeader, showImage, onRightPress } = props
  ...
  return (
      <View style={[ROOT, style, STATUS_BAR_PADDING]}>
        ...
        <View style={LEFT}>
          {showImage && (
              <Image source={IMAGES.logoHeader} style={{ width: 32, height: 32 , marginLeft:10, marginTop: 20}} />
