  ...
  return (
      <>
        ...
        >
          ...
          />
          {props.showHeader && (
              <Header headerText={props.headerTitle} onRightPress={props.onRightPress} style={props.headerStyle}  bigHeader={bigHeader}/>
          )
      ...
      <>
        ...
        >
          <View style={{ flex: 1 }}>
            ...
            />
              {props.showHeader && (
                  <Header headerText={props.headerTitle} style={props.headerStyle} onRightPress={props.onRightPress} showImage={props.showHeaderImage} bigHeader={bigHeader}/>
              )}
